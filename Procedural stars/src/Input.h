...
public:
    ...
    bool IsHeld(KEYBOARD key);
    bool IsHeld(MOUSE key);
...
private:
    ...
    std::map<KEYBOARD, ButtonState> m_keys;
    std::map<MOUSE, ButtonState> m_buttons;
    float m_scrollOffsetX = 0;
    float m_scrollOffsetY = 0;
    GLFWwindow* m_handle;
    static std::map<GLFWwindow*, Input*> sm_inputMap;
};                